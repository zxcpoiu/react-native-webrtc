        ...
        if (constraints.hasKey("video")) {
            ...
            switch (type) {
                case Boolean:
                    ...
                    break;
                case Map:
                    useVideoMap = constraints.getMap("video");
                    if (useVideoMap.hasKey("mandatory") && 
                            useVideoMap.getType("mandatory") == ReadableType.Map) {
                        videoConstraintsManatory = useVideoMap.getMap("mandatory");
                    }
            ...
            if (enableVideo) {
                Log.i(TAG, "getUserMedia(video): useVideoMap: " + useVideoMap
